...
export function buildModeContract(options: {
  ...
  if (options.mode === "plan") {
    return [
      ...
      "Discover: read relevant repo context first, clarify ambiguous requests, and ask focused requirements questions before proposing a plan.",
      "For any non-trivial feature, bugfix, refactor, workflow, or design request, ask at least one requirements-discovery question before proposing or writing a plan.",
      "Focus discovery on understanding the purpose, constraints, and success criteria.",
