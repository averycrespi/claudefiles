...
In this repo, the live `dev-workflow` brief format persists AC in a dedicated `## Acceptance Criteria` section, and the `workflow_brief` tool validates that the section exists before replacing the active brief.
