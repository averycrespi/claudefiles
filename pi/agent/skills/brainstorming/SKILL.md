---
name: brainstorming
description: Use when designing a significant feature that needs requirements exploration and upfront design before implementation
---
...
- Then use `ask_user` to capture the decision
